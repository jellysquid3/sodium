...
public class MipAdjuster {
     ...
     */
    @Unique
    public static void fillInTransparentPixelColors(NativeImage nativeImage) {
    ...
    @Unique
    public static void scaleAlphaToCoverage(NativeImage image, int frameWidth, int frameHeight, int frameIndex, float targetCoverage) {
        ...
        for (int step = 0; step < 10; step++) {
            final float coverage = calculateAlphaCoverage(image, frameWidth, frameHeight, frameIndex, alphaScale);
    ...
    @Unique
    public static float calculateAlphaCoverage(NativeImage image, int frameWidth, int frameHeight, int frameIndex, float alphaScale) {
